...
var targets = {
    all() {
        return fable.promisify(fs.remove, "npm")
            ...
            .then(_ => fable.promisify(fs.copy, "Fable.Import.Mqtt.fs", "npm/Fable.Import.Mqtt.fs"))
            .then(_ => fable.promisify(fs.copy, "Fable.Helpers.Mqtt.fs", "npm/Fable.Helpers.Mqtt.fs"))
